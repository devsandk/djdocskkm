...
class CustomIndexDashboard(Dashboard):
    ...
    def __init__(self, **kwargs):
        ...
        self.children.append(modules.LinkList(
            ...
            collapsible=False,
            children=[
                [_(u'Вернуться на сайт'), '/'],
                [_(u'Сменить пароль'), reverse('admin:password_change')],
                [_(u'Выйти'), reverse('admin:logout')],
            ]
        ))
       ...
       # ))
        ...
        self.children.append(modules.Group(
            title=u'Управление содержимым сайта',
            children=[
                modules.ModelList(
                    u'Справочники сайта',
                    ['docs.models.Coll', 'docs.models.Doc', 'docs.models.Coll4doc']
                   # ['django.contrib.*']
                ),
                modules.ModelList(
                    u'Управление навигацией сайта',
                    ['docs.models.Doctemp', 'docs.models.Tags']
                ),
            ]
        ))
